...
const { UserModel } = require("../../model/themes_properties.model");
const UserService = require('../../service/themes_properties.service');
...
const consultarPorCodigo = async function (req, res) {
    ...
    console.log("consultar 1 thema por codigo");
